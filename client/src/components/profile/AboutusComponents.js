...
export const DayBreakdown = () => {
  ...
  return (
    ...
    <div id='day-titles'>
      ...
      <button value='Wed1' onClick={handleClick}>Wednesday</button>
      <button value='Thur1' onClick={handleClick}>Thursday</button>
      <button value='Fri1' onClick={handleClick}>Friday</button>
      <button value='Weekend' onClick={handleClick}>Weekend</button>
      <button value='Mon2' onClick={handleClick}>Monday</button>
      <button value='Tues2' onClick={handleClick}>Tuesday</button>
      <button value='Wed2' onClick={handleClick}>Wednesday</button>
    </div>
    <div id='daily-text'>
      {sectionDisplay()}
    </div>
