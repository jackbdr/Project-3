export default [
    ...
    solutions: [
      {
        ...
        sol2: 'Fix the problem by trimming the brown leaves from the plant.',
        sol3: 'Fix the problem by trimming the black leaves from the plant.',
      }
    ],
    maxGrowth: '4 metres',
  ...
  },
  {
    ...
    problems: [
      {
        prob1: 'Yellow leaves can be caused through over-watering.',
        prob2: 'Brown leaves can be caused by low humidity and dry air.',
        prob3: 'Leaves may not form slits or holes.',
      }
    ],
    solutions: [
      {
        sol1: 'Watering less should help, if this doesn\'t, the soil may need fertilizer.',
        sol2: 'Changing the pot could help, or adjusting the room\'s humidity.',
        sol3: 'This is usually due to lack of something which will be light, not enough water or not enough fertilizer. ',
      }
    ],
    maxGrowth: '3 metres',
  ...
  },
  {
    ...
    problems: [
      {
        prob1: 'Base rot can be caused by over-watering in cold conditions',
        prob2: '',
        prob3: '',
      }
    ],
    solutions: [
      {
        sol1: 'Remove the most affected parts or discard the whole plant if all the base is completely affected',
        sol2: '',
        sol3: '',
      }
    ],
