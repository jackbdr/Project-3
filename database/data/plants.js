export default [																						
  ...
  {																						
    ...
    light: 'Kalanchoes require a bright but not direct sunlight exposure.',																						
    lightType: 'Indirect',																						
    sunlightFilter: 1,																						
    brightness: 'Bright',																						
    brightnessFilter: 5,																						
  ...
  {																						
    ...
    light: 'For a happy banana plant, place it in a window that receives 12 hours of direct light daily.',																						
    lightType: 'Direct',																						
    sunlightFilter: 5,																						
    brightness: 'Bright',																						
    brightnessFilter: 5,																						
  ...
  {																						
    ...
    light: 'Your zebra plant thrives in bright, indirect light. It can tolerate a couple of hours of direct morning sunlight, but avoid long periods of direct sun and especially direct afternoon sun, which can cause the leaves to scorch. Zebra plants are not adaptable to low light.',																						
    lightType: 'Partially indirect',																						
    sunlightFilter: 2,																						
    brightness: 'Bright',																						
    brightnessFilter: 5,																						
  ...
  {																						
    ...
    light: 'The Silver Satin Pothos prefers partial shade. With bright to moderate indirect light, this plant will thrive and leaves can grow as large as your hand.',																						
    lightType: 'Indirect',																						
    sunlightFilter: 1,																						
  ...
  {																						
    ...
    light: 'Staghorn ferns need bright, indirect or diffused light to thrive, though most species must be protected from the harsh rays of the direct sun. We tell people to put staghorn ferns in the brightest space in their home where, again, the plant will not take direct sun. Rooms with Southern and Eastern exposures tend to be best, though unobstructed North windows will do. Western light is fine, but be careful, as this afternoon exposure tends to be hot and harsh.',																						
    lightType: 'Indirect',																						
    sunlightFilter: 1,																						
    brightness: 'Bright',																						
    brightnessFilter: 5,																						
  ...
  {																						
    ...
    light: 'You need to place the tree outside, all year-round where it is under a bright spot exposed with lots of sunlight. The Juniper plants are not suitable to live indoors.',																						
    lightType: 'Direct',																						
    sunlightFilter: 5,																						
    brightness: 'Bright',																						
    brightnessFilter: 5,																						
  ...
  {																						
    ...
    scientificName: 'Eurphorbia lactea crest',
  ...
  {																						
    ...
    light: 'Plant them in permanent locations with direct sunlight or partial shade. ',																						
    lightType: 'Partially direct',																						
    sunlightFilter: 4,																						
    brightness: 'Bright',																						
    brightnessFilter: 5,																						
